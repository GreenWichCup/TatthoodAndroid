package com.Tatthood.Tatthood.Modules;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.Tatthood.Tatthood.Modules.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.Tatthood.Tatthood.Modules.GlideOptions().apply(toSet));
    }
  }
}
